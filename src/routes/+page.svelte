  ...
  <body class="bg-slate-900 min-h-screen">
    <div class="flex items-start gap-3 w-screen">
      ...
      <main class="p-5 w-full lg:w-3/4">
        <section class="md:bg-slate-800 p-5 rounded-md flex flex-col gap-5">
            <Header {fragment} {isVisible}/>
            <!---Bigger screens-->
            <main class="hidden md:flex w-full p-5 rounded md:overflow-scroll" style="max-height: 75vh;">
              {#if fragment == "about"}
                <About/>
            ...
            <!---Mobile Screens-->
            <main class="md:hidden w-full md:bg-slate-800 p-5 rounded md:overflow-scroll">
                <About/>
                <div class="my-80"></div>          
                <Resume/>
                <div class="my-80"></div>

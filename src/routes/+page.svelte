	...
	<div class="flex items-start gap-3 w-screen">
		...
		<main class="lg:p-5 w-full lg:w-3/4 z-40">
			<section class="lg:bg-slate-800 lg:p-5 rounded-lg flex flex-col gap-5">
				...
				<!---Bigger screens-->
				<main
					class="hidden lg:flex w-full p-5 rounded lg:overflow-y-scroll"
				...
				<!---Mobile Screens-->
				<main
					class="lg:hidden w-screen lg:bg-slate-800 overflow-hidden rounded lg:overflow-y-scroll flex flex-col justify-center items-center gap-3 p-3"
				>
					<div data-aos="flip-up" data-aos-duration="2000" class="w-screen p-3">
						<MyInfo />
					</div>
					<div data-aos="fade-zoom-in-up" data-aos-duration="2000" class=" w-screen p-3">
						<About />
					</div>
					<div data-aos="zoom-in-right" data-aos-duration="2000" class=" w-screen p-3">
						<Skills />
					</div>
					<div data-aos="zoom-in-left" data-aos-duration="2000" class="w-screen p-3">
						<Projects />
					</div>
				</main>
			</section>
